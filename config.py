...
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://sihagankit630:585xpplus@cluster0.hlgcidc.mongodb.net/?appName=Cluster0")
...
OWNER_TAG = os.environ.get("OWNER_TAG", "Snap_Lover8")
UPI_ID = os.environ.get("UPI_ID", "")
QR_PIC = os.environ.get("QR_PIC", "https://telegra.ph/file/3e83c69804826b3cba066-16cffa90cd682570da.jpg")
SCREENSHOT_URL = os.environ.get("SCREENSHOT_URL", f"t.me/snap_lover8")
#--------------------------------------------
#Time and its price
#7 Days
